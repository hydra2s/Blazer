...
export class Zoom {
    constructor(elem, config, wnd) {
        ...
        //
        this.elemParent.addEventListener("pointerdown", this._handleTouchStart, true);
        this.elemParent.addEventListener("pointerdown", this._handleZoom, true);
        document.addEventListener("pointermove", this._handleZoom, true);
