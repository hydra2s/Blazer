...
try {
    ...
    class ScrollBar {
        constructor({className, axisName, sizeCoef, diffOfBox, applicant}) {
            ...
            this._ownSize = ()=>(this.track[["offsetWidth", "offsetHeight"][axisName]]);
            this._parentSize = ()=>(this.track.parentNode[["offsetWidth", "offsetHeight"][axisName]]);
        ...
        get diffOfBox() {
            const _diffOfBox_ = this._diffOfBox();
            if (_diffOfBox_ <= 0) { 
...
`;
        ...
        _updateSize() {
            this._scroll.map((e)=>{ e.ownSize; e.parentSize; });
            return this;
        }
