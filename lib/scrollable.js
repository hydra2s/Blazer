...

            {
                document.addEventListener("pointermove", (e)=> {
                    ...
                    if (this._scrollingX == e.pointerId) {
                        const offsetX = convertPointFromPageToNode(this._trackX.parentNode, e.pageX, e.pageY).x - this._sX;
                    ...
                    if (this._scrollingY == e.pointerId) {
                        const offsetY = convertPointFromPageToNode(this._trackY.parentNode, e.pageX, e.pageY).y - this._sY;
