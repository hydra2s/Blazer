        ...
        constructor() {
            ...
            {   // TODO: better refactor
                document.addEventListener("pointermove", (e)=> {
                    if (this._scrollingX == e.pointerId || this._scrollingY == e.pointerId) { e.preventDefault(); };
                ...
                document.addEventListener("pointerup", (e)=> {
                    if (this._scrollingY == e.pointerId || this._scrollingX == e.pointerId) { 
...
`;
        ...
        _loadFromStorage() {
            if (this.hasAttribute("storage")) {
                if (this._spcX == null) { this._trackX.style.setProperty("--offsetPercent", this._spcX = parseFloat(localStorage.getItem(this.getAttribute("storage") + "_scX")), ""); };
                if (this._spcY == null) { this._trackY.style.setProperty("--offsetPercent", this._spcY = parseFloat(localStorage.getItem(this.getAttribute("storage") + "_scY")), ""); };
        ...
        _updateScroll() {
            ...
            if (this._scrollingX < 0) { this._scrollable.scrollTo({ left: this._spcX * (bounding.width  - this._scrollable.offsetWidth ), behavior: "instant" }); }
            if (this._scrollingY < 0) { this._scrollable.scrollTo({ top : this._spcY * (bounding.height - this._scrollable.offsetHeight), behavior: "instant" }); }
