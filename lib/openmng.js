...
export class MNGRenderer {
    constructor(mng) {
        ...
        this.instruction = this.current.instructions[this.current.iterator];
    ...
    async drawObjects() {
        ...
        while (this.instruction && (this.instruction.type != "SHOW" || ((performance.now() - this.lastTime) >= this.frameTime))) {
