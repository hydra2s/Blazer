...
export class GDI {
    constructor() {
        ...
        if (this.gl.drawingBufferStorage) {
            if (this.u16) {
                this.gl.drawingBufferStorage(this.gl.RGBA16_EXT, this.canvas.width, this.canvas.height);
            } else {
        ...
        //
        if (this.u16) {
            this.gl.renderbufferStorage(this.gl.RENDERBUFFER, this.gl.RGBA16_EXT, this.canvas.width, this.canvas.height);
        } else {
            this.gl.renderbufferStorage(this.gl.RENDERBUFFER, this.gl.RGBA16F, this.canvas.width, this.canvas.height);
        }
    ...
    image(image, index = 0) {
        ...
        //
        if (index == 0) {
            this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.u16 ? this.u16.RGB16_EXT : this.gl.RGB32F, this.gl.RGB, this.u16 ? this.gl.UNSIGNED_SHORT : this.gl.FLOAT, image);
        } else {
