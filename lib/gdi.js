...
export class GDI {
    ...
    gen(func) {
        ...
        //
        const u16 = (this.is16bitRGB || this.is16bitA)?1:0;
...
// for PNG support...
uint _swap16_(in uint a) { return ((a&0xFFu)<<8)|((a&0xFF00u)>>8); }
uint _inc_(in uint c, in int p) { return c<<p; }

//
void main() {
    uvec4 _color0_ = texture(_image0_, texcoord);
    uvec4 _color1_ = texture(_image1_, texcoord);
    uint R0 = _inc_(_color0_.r, _shift0_), G0 = _inc_(_color0_.g, _shift0_), B0 = _inc_(_color0_.b, _shift0_), A0 = _inc_(_color0_.a, _shift0_);
    uint R1 = _inc_(_color1_.r, _shift1_), G1 = _inc_(_color1_.g, _shift1_), B1 = _inc_(_color1_.b, _shift1_), A1 = _inc_(_color1_.a, _shift1_);
