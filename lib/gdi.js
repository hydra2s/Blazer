...
void main() {
    ...
    get isU16() {
        return this.is16bitRGB || this.is16bitA;
    }

    // TODO: using pngjs3 for 16-bit colors
    getImageData(x, y, width, height, options = {}) {
        const u16 = this.is16bitRGB || this.is16bitA;
        const pixels = options.buffer ? new (u16 ? Uint16Array : Uint8Array)(options.buffer, options.byteOffset, width * height * 4) : new (u16 ? Uint16Array : Uint8Array)(width * height * 4);
        if (this.fb) { 
